...
NYC_Edge_ML <- NYC_Edge %>%
  mutate(modele = "Edge", Location = "New York City")
...
```{r}
df_list <- list(NYC_Taurus_ML, NYC_Mustang_ML, NYC_Fusion_ML, NYC_Focus_ML, NYC_Fiesta_ML, NYC_F350_ML, NYC_F250_ML, NYC_F150_ML, NYC_Explorer_ML, NYC_Escape_ML, NYC_Edge_ML)
